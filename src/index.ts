...
const a=onSelected((view)=>{
  console.log("选中")
});
console.log(a)
removeListener("onSelect",a);
const textBox = createTextBox(
  "可视化结果以Json的形式存在，用户可以编辑Json实现特殊化操作，如：数据for &nmatter，文本变色,单元格改变背景等。具体请参考文档。啊可视化结果以Json的形式存在，用户可以编辑Json实现特殊化操作，如：数据formatter，文本变色,单元格改变背景等。具体请参考文档。啊可视化结果以Json的形式存在，用户可以编辑Json实现特殊化操作，如：数据formatter，文本变色,单元格改变背景等。具体请参考文档。啊",
  {
    fontSize: 10,
    lineWidth:1,
    lineHeight:0,
